...
# with command line options: step1 --filein root://eoscms//eos/cms/store/user/mshi/gg2H2aa2mumutautau_sim_19GeV --fileout file:gg2H2aa2mumutautau_19GeV_step1.root --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIISummer15GS-MCRUN2_71_V1-v2/GEN-SIM --mc --eventcontent RAWSIM --pileup 2015_25ns_FallMC_matchData_PoissonOOTPU --datatier GEN-SIM-RAW --conditions 76X_mcRun2_asymptotic_v12 --step DIGI,L1,DIGI2RAW,HLT:@frozen25ns --era Run2_25ns --python_filename gg2H2aa2mumutautau_19GeV_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 300
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://eoscms//eos/cms/store/user/mshi/gg2H2aa2mumutautau_sim_19GeV/gg2H2aa2mumutautau_sim_19GeV_NUM.root'),
